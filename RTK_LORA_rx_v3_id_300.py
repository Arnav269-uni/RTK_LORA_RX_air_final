"""
RTK_LORA_rx_v3_id_300.py  (ADDRESS=300)  --  DIAGNOSTIC / EMI logging build
...
# ==================== Main ====================
def main():
    print("Hardcoded module ADDRESS: 300  [v3 ESR / DIAGNOSTIC LOGGING BUILD]")
    lora_port = "COM5"
    fc_conn_str = "COM6"
    fc_baud = 115200
